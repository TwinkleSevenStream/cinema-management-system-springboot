...
public class ViewController {
    ...
    @RequestMapping(value = "/admin/vip/management")
    public String AdminVipManage() {
        return "adminVipManagement";
    }

    @RequestMapping(value = "/admin/ticket/management")
    public String AdminTicketManage() {
    ...
    @RequestMapping(value = "/admin/ticket/refundStrategyManage")
    public String AdminRefundStrategy() {
        return "adminRefundStrategyManage";
    }

//    @RequestMapping(value = "/topAdmin/movie/manage")
