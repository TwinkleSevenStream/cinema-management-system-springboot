...
import com.example.cinema.vo.MovieFormWithOldName;
...
public class MovieController {
    ...
    public ResponseVO modifyMovie(@RequestBody MovieFormWithOldName mMovieForm){
        return movieService.modifyMovie(mMovieForm);
    }
    ...
    @GetMapping("/movie/withdraw/{name}")
    public ResponseVO withdrawMovie(@PathVariable String name){
        return movieService.withdrawMovie(name);
    }
