...
import  com.example.cinema.po.TicketsWithScheduleId;
...
//    edwin：
    List<TicketsWithScheduleId> selectTicketByTime(@Param("date") Date date, @Param("nextDate") Date nextDate);


    List<MovieTotalBoxOffice> selectMovieBoxOfficeWithTime(@Param("date") Date date, @Param("nextDate") Date nextDate);
//    and  time between #{date} and #{nextDate}
