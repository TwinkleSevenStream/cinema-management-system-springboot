...
$(document).ready(function() {
        ...
        getRequest(
            ...
            function (res) {
                ...
                halls.forEach(function (hall) {
                    $('#hall-select').append("<option value="+ hall.id +">"+hall.hallname+"</option>");
                    $('#schedule-hall-input').append("<option value="+ hall.id +">"+hall.hallname+"</option>");
                    $('#schedule-edit-hall-input').append("<option value="+ hall.id +">"+hall.hallname+"</option>");
                });
                getSchedules();
            },
            function (error) {
    ...
    $('#schedule-form-btn').click(function () {
        ...
        //TODO 需要做一下表单验证？  即输入的数据不和其他冲突，我需要干啥？  它都写好了。。。。。。
